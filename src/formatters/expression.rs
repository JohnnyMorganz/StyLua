...
fn format_hanging_expression_(
    ...
    match expression {
        ...
        Expression::TypeAssertion {
            ...
            let value_shape = shape.take_first_line(&strip_trivia(type_assertion));

            let expression = Box::new(match &**expression {
                Expression::Parentheses { .. } => format_hanging_expression_(
                    ctx,
                    expression,
                    value_shape,
                    ExpressionContext::TypeAssertion,
